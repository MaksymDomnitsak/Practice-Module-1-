...
class Calculator
  ...
  def calculation arr
    ...
    case arr[0]
    when '1' then result = arr[1].to_f + arr[2].to_f
    when '2' then result = arr[1].to_f - arr[2].to_f
    when '3' then result = arr[1].to_f * arr[2].to_f
    when '4' then result = arr[1].to_f / arr[2].to_f
    when 'q' then false
    else
